...
/// Whether the typesetter should save layout sizes for a particular set of
...
/// The font that the typesetter will use to calculate glyph sizes and bounding
/// box positions
...
/**
 * The optimal length and width of the bounding box that can be used to render a
 *particular multi-line
 * string of text with a specific layout parameters with a limit on the maximum
 *width and height of
 * the text permitted
 *
 * @param text The string of text that the typesetter will lay out
 * @param font The font that the typesetter will use to calculate glyph sizes
 *and bounding box positions
 * @param layoutInfo The typesetter specific parameters that are used to
 *influence the text layout
 * @param size The maximum \b width and \b height that the return value may have
 *
 * @return The optimal \b width and \b height of the bounding box for the given
 *text and parameters
 */
 ...
 *
 * @return The dictionary of parameter keys and values that the typesetter will
 *use by default
 */
...
/**
 * The \b width and \b height of the bounding box that the typesetter will use
 *when laying out the current text
 * with the current font and layoutInfo
 *
 * @param The maximum \b width and \b height constraint
 *
 * @return The optimap \b width and \b height that can be used to render the
 *text set in the typsetter
 */
