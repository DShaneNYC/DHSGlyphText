...
/// The location to store the point locations of the origins of the glyphs for
/// rendering
@property(nonatomic, readwrite) CGPoint *points;
/// The location to store the sizes of the bounding boxes of the individual
/// glyphs
...
/**
 * The ratio of spaces to other characters in the given text. This can help to
 *determine what sort
...
/**
 * Set an individual layout parameter instead of using \b setLayoutInfo to set
 *them all at once
 *
 * @param infoItem The value of the layout info parameter to set
 * @param key The key of the layout info parameter to set. Must be compatible
 *with the layout info for this class.
 */
- (void)setLayoutInfoValue:(id)infoItem
                    forKey:(DHSGlyphTypesetterLayoutInfo)key;
...
/**
 * The ratio of spaces to other characters in the text set in the typesetter.
 *This can help to
 * determine what sort of layout parameters and techniques to use in laying out
 *the text.
 *
 * @return The ratio of spaces to other characters
 */
...
/**
 * Called by the typesetter to layout the retained text. Subclasses should
 *implement this method to customize the layout and optionally call super.
 *
 * @param glyphs The glyphs for the retained text in the retained font to be
 *laid out will be in this array
 * @param points The array this method will use to store the glyph point
 *locations
 * @param rotations The array this method will use to store the individual glyph
 *rotations
 * @param length The size of both the \b glyphs and \b points arrays. This
 *should be same as the length of the retained text.
