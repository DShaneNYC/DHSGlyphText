...
- (void)setLayoutInfo:(NSDictionary *)layoutInfo {
  ...
  NSMutableDictionary *info =
      [_layoutInfo count]
          ...
          : [NSMutableDictionary
                dictionaryWithDictionary:[[self class] defaultLayoutInfo]];
...
- (void)setLayoutInfoValue:(id)infoValue
...
- (NSString *)hashForText:(NSString *)text
  ...
  return [NSString
      stringWithFormat:@"%lX", (unsigned long)text.hash ^
                                   (unsigned long)font.hash ^
                                   (unsigned long)
                                       [[NSValue valueWithCGSize:size] hash] ^
