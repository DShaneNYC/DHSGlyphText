...
typedef enum {
  /// Line layout style that will center lines in the layout rect based on the
  /// default line spacing
  DHSGlyphTypesetterLineLayoutStyleCenter = 0,
  /// Line layout style that will spread lines in the layout rect based on the
  /// default line spacing and a line layout style multiplier
