...
- (void)setDefaults {
    ...
    self.lineLayoutStyle = [layoutInfo[@(DHSGlyphTypesetterLineLayoutInfoLineLayoutStyle)] intValue];
    self.lineLayoutStyleMultiplier = [layoutInfo[@(DHSGlyphTypesetterLineLayoutInfoLineLayoutStyleMultiplier)] floatValue];
...
- (NSDictionary *)layoutInfo {
    ...
    if ([self.typesetter isKindOfClass:[DHSGlyphTypesetterLine class]]) {
        ...
        info[@(DHSGlyphTypesetterLineLayoutInfoMaxNumberOfLines)] = @(self.numberOfLines);
        info[@(DHSGlyphTypesetterLineLayoutInfoTextAlignment)] = @(self.textAlignment);
        info[@(DHSGlyphTypesetterLineLayoutInfoShadowOffset)] = [NSValue valueWithCGSize:self.shadowOffset];
        info[@(DHSGlyphTypesetterLineLayoutInfoStrokeWidth)] = @(self.strokeWidth);
        info[@(DHSGlyphTypesetterLineLayoutInfoShiftsToShadowOffset)] = @(self.shiftsToShadowOffset);
        info[@(DHSGlyphTypesetterLineLayoutInfoLineLayoutStyle)] = @(self.lineLayoutStyle);
        info[@(DHSGlyphTypesetterLineLayoutInfoLineLayoutStyleMultiplier)] = @(self.lineLayoutStyleMultiplier);
    }
