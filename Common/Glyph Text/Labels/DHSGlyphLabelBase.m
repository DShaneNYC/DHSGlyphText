...
@implementation DHSGlyphLabelBase
...
- (void)setDefaults {
    ...
    _typesetter = [DHSGlyphTypesetterBase new];
...
- (NSDictionary *)layoutInfo {
    ...
    if ([self.typesetter isKindOfClass:[DHSGlyphTypesetterBase class]]) {
...
- (void)setTypesetter:(DHSGlyphTypesetterBase *)typesetter {
