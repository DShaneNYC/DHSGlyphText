...
/// Whether the label should save rendered images for a particular set of
/// parameters in a cache
@property(nonatomic, readwrite) BOOL shouldCache;
/// The typesetter that the label will use to layout the text glyphs from the
/// current font
@property(nonatomic, readwrite) DHSGlyphTypesetter *typesetter;
/// The current font based on the the preferred selection method and glyph
/// availability
@property(nonatomic, readonly) DHSGlyphFont *currentFont;
/// Whether the label should always prefer the default font or the system
...
/// Whether the shadow, if used, should be applied to the stroke outline of the
/// text or not
@property(nonatomic, readwrite) BOOL strokeHasShadow;
/// Whether the text should shift to the label's drop shadow offset ( as defined
/// by \b shadowOffset ) so it can be used for a button press
 ...
 *
 * @return Returns the retained \b DHSGlyphFont instance or nil if it is not
 *available for the given key
 */
- (DHSGlyphFont *)fontForKey:(NSString *)key;

/**
 * Set a \b DHSGlyphFont instance for a provided identifier and retain it in the
 *label
 *
...
/**
 * Get a \b DHSGlyphFont instance that is stored in the label for the current
 *system preferred language
 *
 * @return Returns the retained \b DHSGlyphFont instance or nil if it is not
 *available for preferred language
 */
 ...
 *kDHSGlyphDefaultKey ) and retain it in the label
 *
 * @param fontName The name of the font in the main bundle used to create the \b
 *DHSGlyphFont instance to retain
 *
 ...
 *kDHSGlyphSystemKey ) and retain it in the label
 *
 * @param fontName The name of the font in the main bundle used to create the \b
 *DHSGlyphFont instance to retain
 *
