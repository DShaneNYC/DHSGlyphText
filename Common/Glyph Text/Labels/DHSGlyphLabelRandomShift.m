...
- (void)setDefaults {
  ...
  self.horizontalRatioMin = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoHorizontalRatioMin)] floatValue];
  self.horizontalRatioMax = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoHorizontalRatioMax)] floatValue];
  self.verticalRatioMin = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoVerticalRatioMin)] floatValue];
  self.verticalRatioMax = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoVerticalRatioMax)] floatValue];
  self.rotationMin = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoRotationMin)] floatValue];
  self.rotationMax = [layoutInfo[
      @(DHSGlyphTypesetterRandomShiftLayoutInfoRotationMax)] floatValue];
...
- (NSDictionary *)layoutInfo {
  ...
  if ([self.typesetter isKindOfClass:[DHSGlyphTypesetterRandomShift class]]) {
    ...
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoHorizontalRatioMin)] =
        @(self.horizontalRatioMin);
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoHorizontalRatioMax)] =
        @(self.horizontalRatioMax);
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoVerticalRatioMin)] =
        @(self.verticalRatioMin);
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoVerticalRatioMax)] =
        @(self.verticalRatioMax);
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoRotationMin)] =
        @(self.rotationMin);
    info[@(DHSGlyphTypesetterRandomShiftLayoutInfoRotationMax)] =
        @(self.rotationMax);
  }
